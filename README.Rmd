...
Agricultural research and farm management are increasingly becoming digital. Depending on the applications, the equipment used in farm operations and data collection are connected to the internet, satellites and generates rich meta-data. These meta-data has the potential to become key research support tools that generates new opportunity.
