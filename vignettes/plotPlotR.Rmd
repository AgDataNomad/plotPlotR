...
Plots (or experiments as a whole) can be moved horizontally, vertically, along its run or range or along North-South or East-West direction in a number of ways using **plotPlotR**. Some of the transformations require   
