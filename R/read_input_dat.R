...
#' @param input_CRS Numeric input. CRS of input data as EPSG code
#' @param to_CRS_M NUmeric input. Corresponding CRS in unit M to input CRS as EPSG code
#'
...
#' dat
#'
read_input_dat <- function(input_dat, input_CRS, to_CRS_M){
  ...
  if (!is.na(st_crs(dat)$input)){
    ...
    st_crs(dat) <- as.numeric(input_CRS)
